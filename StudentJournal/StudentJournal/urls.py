...
urlpatterns = [
    ...
    path('classes/studied_disciplines/<int:class_num>/', users.views.studied_disciplines),
    ...
    path('schedule/teacher_schedule/<int:teacher_id>/<int:term>/', scheduling.views.teacher_schedule),
    ...
    path('discipline_choices/<int:class_id>/<int:term>/', scheduling.views.discipline_choices),
