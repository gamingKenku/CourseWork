    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homeroom_teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='homeroom_teacher_to_class', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='DisciplineName',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('discipline', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='discipline_to_teacher', to='users.DisciplineName')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher_to_discipline', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_to_class', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['class_code'],
